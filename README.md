...
##### Requires: 
* **MS Visual Studio 2013 (v120)**: https://go.microsoft.com/fwlink/?LinkId=532606&clcid=0x409  (or offline [ISO image](https://go.microsoft.com/fwlink/?LinkId=615448&clcid=0x409))
...
* **OpenCV 2.4.10**: https://sourceforge.net/projects/opencvlibrary/files/opencv-win/2.4.10/opencv-2.4.10.exe/download
  ...
  - To compile with different OpenCV version - change in file yolo.c each string look like **#pragma comment(lib, "opencv_core2410.lib")** from 2410 to required version.
...
1. If you have MSVS 2013, CUDA 8.0 and OpenCV 2.4.10 (with paths: `C:\opencv_2.4.10\opencv\build\include` & `C:\opencv_2.4.10\opencv\build\x64\vc12\lib` or `vc14\lib`), then start MSVS, open `build\darknet\darknet.sln`, set **x64** and **Release**, and do the: Build -> Build darknet

  1.1. Find files `opencv_core2410.dll`, `opencv_highgui2410.dll` and `opencv_ffmpeg2410_64.dll` in `C:\opencv_2.4.10\opencv\build\x64\vc12\bin` or `vc14\bin` and put it near with `darknet.exe`
...
3. If you have other version of OpenCV 2.4.x (not 2.4.10) then you should change pathes after `\darknet.sln` is opened
  ...
  3.3 Open file: `\src\yolo.c` and change 3 lines to your OpenCV-version - `2410` (for 2.4.10), `2413` (for 2.4.13), ... : 
...
Also, you can to create your own `darknet.sln` & `darknet.vcxproj`, this example for CUDA 8.0 and OpenCV 2.4.10

Then add to your created project:
- (right click on project) -> properties  -> C/C++ -> General -> Additional Include Directories, put here: 

`C:\opencv_2.4.10\opencv\build\include;..\..\3rdparty\include;%(AdditionalIncludeDirectories);$(CudaToolkitIncludeDir);$(cudnn)\include`
...
`C:\opencv_2.4.10\opencv\build\x64\vc12\lib;$(CUDA_PATH)lib\$(PlatformName);$(cudnn)\lib\x64;%(AdditionalLibraryDirectories)`
...
- open file: `\src\yolo.c` and change 3 lines to your OpenCV-version - `2410` (for 2.4.10), `2413` (for 2.4.13), ... : 
...
`opencv_core2410.dll`, `opencv_highgui2410.dll` and `opencv_ffmpeg2410_64.dll` in `C:\opencv_2.4.10\opencv\build\x64\vc12\bin` or `vc14\bin`
